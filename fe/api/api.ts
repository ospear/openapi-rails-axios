...
export const PetsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        listPets: async (status: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'status' is not null or undefined
            assertParamExists('listPets', 'status', status)
            const localVarPath = `/pets`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const PetsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async listPets(status: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Pet>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listPets(status, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const PetsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        listPets(status: string, options?: any): AxiosPromise<Array<Pet>> {
            return localVarFp.listPets(status, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Info for a specific pet
...
export class PetsApi extends BaseAPI {
     ...
     * @memberof PetsApi
     */
    public listPets(status: string, options?: AxiosRequestConfig) {
        return PetsApiFp(this.configuration).listPets(status, options).then((request) => request(this.axios, this.basePath));
    }
